  ...
  return (
    <Stack direction="row">
      <Box py={2}>
        ...
        >
          Welcome to our pet adoption center! Here, you can meet many wonderful
          pets who are looking for a loving home. Whether you&apos;re searching
          for a playful puppy, a cuddly kitten, or a loyal companion, we have
          the perfect pet waiting for you. Join us in giving these animals a
          second chance at happiness and a forever home
        </Typography>
